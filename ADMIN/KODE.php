...
<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' bgcolor=#FFFFFF>
  ...
  <tr valign='top'> 
    ...
    <td width='100' align=center valign='top'><font size=3>Tahun<br>Perolehan</td>
...
<th bgcolor=#FFCC00 align=center valign=top><TABLE WIDTH=><td align=center>
	<input type=$T SIZE=10 name=KONDISI value='$data_cari[KONDISI]'>
	</TABLE>

<th bgcolor=#FFCC00 align=center valign=top><TABLE WIDTH=><td align=center>
	<input type=$T SIZE=10 name=TAHUN value='$data_cari[TAHUN]'></TABLE>
<th bgcolor=#FFCC00 align=center valign=top><TABLE WIDTH=><td align=center>
	<input type=$T SIZE=10 name=NILAI value='$data_cari[NILAI]'></TABLE>
<th bgcolor=#FFCC00 align=center valign=top><TABLE WIDTH=><td align=center>
	<input type=$T SIZE=10 name=SUMBER value='$data_cari[SUMBER]'></TABLE>
<th bgcolor=#FFCC00 align=center valign=top><TABLE WIDTH=><td align=center>
